    ...
    <div>
        <div className="relative overflow-hidden" id='sans'>
            <div className="absolute h-screen overflow-hidden top-0 left-0 -z-10">
                <div className="h-3/4 xl:h-3/4 overflow-hidden">
                    <div className="black h-3/4 xl:h-3/4 w-screen bg-black opacity-60 absolute top-0 left-0"></div>
            ...
            <div className="rspn2 h-full w-screen container mx-auto xl:mt-[150px] px-8" id='sans'>
                ...
                <div className="grid my-10 space-y-5 lg:space-y-10">
                    <div className="flex cursor-pointer transition-all duration-700 hover:scale-125 lg:w-max lg:mx-auto">
                        ...
                        <button className='text-xl lg:text-2xl ml-2'>+62 821-1996-5025</button>
                    </div>
                    <div className="flex cursor-pointer transition-all duration-700 hover:scale-125 lg:w-max lg:mx-auto">
                    ...
                    <div className="flex cursor-pointer transition-all duration-700 hover:scale-125 lg:w-max lg:mx-auto">
                        ...
                        <button className='text-xl lg:text-2xl ml-2'>anotherfreshh@gmail.com</button>
                    </div>
                </div>
                <p className='text-center text-[26px] md:text-[40px] lg:text-[48px] font-semibold border-b border-t border-black'>Sosial media</p>
                <div className="grid my-10 space-y-5 lg:space-y-10">
                    <div className="flex cursor-pointer transition-all duration-700 hover:scale-125 lg:w-max lg:mx-auto">
                        ...
                        <button className='text-xl lg:text-2xl ml-2'>Another Fresh</button>
                    </div>
                    <div className="flex cursor-pointer transition-all duration-700 hover:scale-125 lg:w-max lg:mx-auto">
                        ...
                        <button className='text-xl lg:text-2xl ml-2'>Anotherfresh</button>
                    </div>
                    <div className="flex cursor-pointer transition-all duration-700 hover:scale-125 lg:w-max lg:mx-auto">
                        ...
                        <button className='text-xl lg:text-2xl ml-2'>Another Fresh Official</button>
                    </div>
                </div>
            </div>
            <Footer />
